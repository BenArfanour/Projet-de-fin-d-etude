...
class user extends BaseUser {
   ...
   /**
     * @ORM\OneToMany(targetEntity="PfeBundle\Entity\programmevol",mappedBy="users" ,cascade={"remove", "persist"})
     */
    private $programmesvols;


    /**
     * @ORM\OneToMany(targetEntity="NoteserviceBundle\Entity\Notesrv" , mappedBy="admin",cascade={"remove", "persist"})
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="NewsBundle\Entity\News_PNC",mappedBy="pncs",cascade={"remove", "persist"})
     */
     private $NP;

    /**
     * @ORM\OneToMany(targetEntity="RammassageBundle\Entity\Rammassage" , mappedBy="pncs",cascade={"remove", "persist"})
     */
